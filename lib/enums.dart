...
enum ClientType {
  samsung(
    ...
    '[무인보관함 프로젝트]',
    '2024.06 ~ 2025.02',
    '삼성전자 무인보관함 키오스크 프론트엔드 개발',
    '삼성전자 DS에 제공하는 무인보관함(키오스크)의 관제페이지를 구현하는 역할을 맡아 기존 개발부서에서 사용하던 레거시 코드를 Flutter로 리팩토링하여 고객사에 빠른 개발 산출물 제공',
  ),
  saig(
    'assets/images/clients/client_saig.png',
    '[ThinkAI 프로젝트]',
    '2024.02 ~ 2024.06',
    'iFLYTEK 번역 앱의 프론트엔드 및 관리자페이지 구현',
    '',
  ),
  mz(
  ...
  hmcLge(
    ...
    '[고급형 AVN]',
    '2011.11 ~ 2018.11',
    '현대자동차 고급형 프로젝트의 SW 구조 설계 및 양산 업무',
    '',
  );
